...
* engineering and selecting features- **Engineering.ipynb**
* fitting models to data- **Modeling.ipynb**
* creating pipeline for entries from new applicants without credit history- **Finalising_pipeline.ipynb**
* deploying best performing model to Google Cloud Platform- **deployment_fastapi** , **deployment_vertexai**
